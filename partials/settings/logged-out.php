<div class="ecwc-not-logged-container">
	...
	<div class="ecwc-not-logged" id="ecwc-not-logged">
		...
		<p class="ecwc-text-center ecwc-not-logged-signup">
            <?php _e( "Not a member?", "emailchef-for-woocommerce" ); ?> <a target="_blank" href="https://app.emailchef.com/apps/demo/quicksignup"><?php _e( "Sign up for free", "emailchef-for-woocommerce" ); ?></a>.
        </p>
		...
		<fieldset>
			...
			<div class="ecwc-not-logged-control-group">
				...
				<label for="<?php echo esc_attr( wc_ec_get_option_name( "consumer_key" ) ); ?>" class="ecwc-not-logged-get-api">
                    <?php _e( "Consumer Key:", "emailchef-for-woocommerce" ); ?>
					<a href="https://app.emailchef.com/build/#/settings/apikeys" target="_blank" class="ecwc-get-api"><?php _e( "Get API Key", "emailchef-for-woocommerce" ); ?></a>
				</label>
			...
			<div class="ecwc-not-logged-control-group ecwc-not-logged-password-field">
                ...
                <label for="<?php echo esc_attr( wc_ec_get_option_name( "consumer_secret" ) ); ?>"><?php _e( "Consumer Secret:", "emailchef-for-woocommerce" ); ?></label>
                ...
                <a id="showPassword" title="<?php _e( "Show Consumer Secret", "emailchef-for-woocommerce" ); ?>">
                ...
                <a id="hidePassword" style="display: none" title="<?php _e( "Hide Consumer Secret", "emailchef-for-woocommerce" ); ?>">
